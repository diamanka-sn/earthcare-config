...
def plot_orbits_by_period(orbites: list[dict],
    ...
    # Le temps EarthCARE est en secondes depuis 2000-01-01 00:00:00
    ...
    def _orbit_date(orb):
        ...
        if t is None:
            return EPOCH
        return EPOCH + timedelta(seconds=float(np.nanmean(t)))
...
def _orbit_dates(orbites):
    ...
    for orb in orbites:
        ...
        if t is None:
            ...
            dates.append(EPOCH + timedelta(seconds=float(np.nanmean(t))))
    return dates
